...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->CopyToolStripMenuItem->Click += gcnew System::EventHandler(this, &ExplorerForm::êîïèğîâàòüToolStripMenuItem_Click);
			// 
			...
			this->DeleteToolStripMenuItem->Click += gcnew System::EventHandler(this, &ExplorerForm::óäàëèòüToolStripMenuItem_Click);
			// 
			...
			this->RenameToolStripMenuItem->Click += gcnew System::EventHandler(this, &ExplorerForm::ïåğåèìåíîâàòüToolStripMenuItem_Click);
			// 
			...
			this->PropertyToolStripMenuItem->Click += gcnew System::EventHandler(this, &ExplorerForm::ñâîéñòâàToolStripMenuItem_Click);
			// 
			// menuStrip
			// 
...
#pragma endregion
	...
	private: System::Void ïåğåèìåíîâàòüToolStripMenuItem_Click(System::Object^ sender, System::EventArgs^ e);
